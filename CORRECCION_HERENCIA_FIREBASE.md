...
Para depurar el problema de la proyección, se recomienda ejecutar en consola:

```js
window.votingSystem.loadData().then(() => console.log(window.votingSystem.votes.length))
```

Esto simulará registros automáticos y ayudará a determinar si el problema es de datos o de renderizado.
